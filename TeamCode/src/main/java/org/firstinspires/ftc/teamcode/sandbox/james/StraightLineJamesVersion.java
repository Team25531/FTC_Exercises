package org.firstinspires.ftc.teamcode.sandbox.james;
...
@Autonomous(name = "James: StraightLine", group = "James")
@Disabled//we need to add the DcMotors
public class StraightLineJamesVersion extends LinearOpMode {
