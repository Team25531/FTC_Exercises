...
@TeleOp(name = "UtilityCamFrameCapture", group = "Aaron")
@Disabled
public class UtilityCamFrameCapture extends LinearOpMode
{
    /*
    ...
    final int RESOLUTION_WIDTH = 320;//640;
    final int RESOLUTION_HEIGHT = 240;//480;
